void *os_win32_reserve(u64 size)
{
...
b32 os_win32_commit(void *ptr, u64 size)
{
...
void os_win32_decommit(void *ptr, u64 size)
{
	VirtualFree(ptr, size, MEM_DECOMMIT);
}

void os_win32_release(void *ptr, u64 size)
{
...
{
	os_win32_reserve(size);
}

b32 os_commit(void *ptr, u64 size)
{
	return os_win32_commit(ptr, size);
}

void os_decommit(void *ptr, u64 size)
{
	os_win32_decommit(ptr, size);
}

void os_release(void *ptr, u64 size)
{
	os_win32_release(ptr, size);
}
#endif